...
export const useLayananPoli = defineStore('layanan-poli', {
  state: () => ({
    tab: 'Diagnosa Medik',
    tabs: ['Diagnosa Medik', 'Tindakan Medik', 'Prosedur (Icd 9)', 'Diagnosa Keperawatan', 'Laporan Tindakan', 'Pra Anestesia'],
    // diagnosa
    searchdiagnosa: '',
    listDiagnosa: [],
    listTindakan: [],
  ...
  actions: {
    ...
    initReset(x) {
      ...
      return new Promise((resolve, reject) => {
        this.tab = tabbed
        this.tabs = ['Diagnosa Medik', 'Tindakan Medik', 'Prosedur (Icd 9)', 'Diagnosa Keperawatan', 'Laporan Tindakan', 'Pra Anestesia']
